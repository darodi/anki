...
#
# Created: Fri Jun 14 23:31:46 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        QtGui.QListWidgetItem(self.cardType)
        QtGui.QListWidgetItem(self.cardType)
        QtGui.QListWidgetItem(self.cardType)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cardType.item(0).setText(_("New cards only"))
        self.cardType.item(1).setText(_("Due cards only"))
        self.cardType.item(2).setText(_("All cards in random order (cram mode)"))
